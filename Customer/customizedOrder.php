    ...
    <div class="row">
        ...
        <div class="col-md-12 d-flex justify-content-end">
            <h5 class="me-auto p-3 display-1 text-center"
                style="font-weight: 500; font-family: fantasy; color: #4a4a4a; text-shadow: 5px 8px 3px #00ffb3; ">CUSTOMIZED ORDER</h5>
        ...
        if (mysqli_num_rows($orders) > 0) {
            foreach ($orders as $item) {
                ...
                <div class="col-md-3">
                    <section class="page-contain mb-5">
                        <a href="viewCustomizedOrder.php?t=<?= $item['tracking_no']; ?>" class="data-card">
            ...
            ?>
                        <div class="container text-center">
                                    <h5 class="fw-bold bg-danger text-light p-3">No customized order</h5>
                            </div>
