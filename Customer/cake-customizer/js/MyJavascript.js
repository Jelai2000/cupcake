        ...
        function saveDesain(){
            html2canvas($('#container'), {
                onrendered: function(canvas) {
                    ...
                    saveAs(blob, "cupcake-customization.png");
                    }, "image/png");
                }
            });
        }    
            ...
            if (input.files && input.files[0]) {
                ...
                $(reader).load(function(theFile) {
                    //get the data uri
                            ...
                            +"<img src="+dataURI+" id="+ImageDropID+" style='max-width:350px;max-height:410px;position:relative;z-index:9999;'/></div></div>").appendTo("#making").draggable({containment: "#making"});
